namespace NasaTVScheduleImport
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.BEGIN_DATE_TV.DefaultCellStyle = dataGridViewCellStyle3;
			...
			this.BEGIN_DATE_OL.DefaultCellStyle = dataGridViewCellStyle4;
			...
			this.Name = "MainForm";
			this.Text = "NASA STS TV Schedule Import to Outlook Calendar";
