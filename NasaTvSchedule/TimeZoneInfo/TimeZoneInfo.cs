...
/// 
/// Solves problem of converting between time zones.  Something that the .Net framework, prior to the 3.5 Beta does not do.
/// Project that this is needed for needs to convert from Central Time (Johnson Space Center, Houston, TX) to Eastern Time (for me) and other time zones to make it adaptable for others.
/// </summary>
/// <returns></returns>
